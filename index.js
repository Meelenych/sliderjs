...
if (images.length) {
    ...
    <div class="background__slide swiper-slide">
      <div class="background__image">            
		...
		textSlides += `<div class="text__slide swiper-slide">
    <span>${image.dataset.title ? image.dataset.title : ''}</span>
    </div>`;
	});

	const background = `
  <div class="background__swiper">
...
`;
	...
	page.insertAdjacentHTML('beforend', text);

	let pageBgSlider = new Swiper('.background', { speed: 500 });
	...
	pageBgSlider.controller.control = pageBgSlider;
